            ...
            >
              ...
              >
                  ...
                  className={`text-white transition-opacity duration-200 ${
                    hoverIndex === 0 || selectedChain === 'ETH+' ? 'opacity-100' : 'opacity-0'
                  }`} 
                  size={18} 
                />
              ...
              >
                <ChevronRight 
                  className={`text-white transition-opacity duration-200 ${
                    hoverIndex === 1 || selectedChain === 'Solana' ? 'opacity-100' : 'opacity-0'
                  }`} 
                  size={18} 
                />
                <div className="flex items-center">
          ...
          {selectedChain ? (
            <div className="relative group cursor-pointer mb-4 flex justify-center ">
             ...
             <div className="text-center">
               <p className="uppercase barlow-black text-[24px] leading-[27px] text-center">CONNECT<br />AND SIGN</p>
             </div>
